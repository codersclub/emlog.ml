        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body" id="admindex_msg">
                    <ul class="list-group list-group-flush">
                        <li class="msg_type_0"><a href="https://www.emlog.net/docs/#/faq" target="_blank">FAQ</a></li>
                        <li class="msg_type_0"><a href="https://github.com/emlog/emlog/issues" target="_blank">issues</a></li>
                    </ul>
                </div>
            </div>
        </div>
