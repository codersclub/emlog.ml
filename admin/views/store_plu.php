...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        ...
        <a href="./store.php?action=plu&tag=free_top" class="badge badge-light text-primary m-1 p-2 small"><?= lang('rank_free') ?>-TOP12</a>
        <a href="./store.php?action=plu&tag=paid_top" class="badge badge-light text-primary m-1 p-2 small"><?= lang('rank_paid') ?>-TOP12</a>
    </div>
...
<!--vot-->                          <?= lang('update_time') ?>: <?= $v['update_time'] ?><br>
                            ...
                            <div class="card-text d-flex justify-content-between">
                                ...
                                <?php if ($v['price'] > 0): ?>
<!--vot-->                          <a href="https://emlog.io/order/submit/plugin/<?= $v['id'] ?>" class="btn btn-danger" target="_blank"><?= lang('go_buy') ?></a>
                                <?php else: ?>
