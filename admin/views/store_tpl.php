...
<div class="d-flex flex-column flex-sm-row justify-content-between mb-4 ml-1">
    <div class="mb-3 mb-sm-0">
        ...
        <a href="./store.php?action=tpl&tag=download_top" class="badge badge-light text-primary m-1 p-2 small"><?= lang('top_down') ?></a>
        <a href="./store.php?action=tpl&tag=paid_top" class="badge badge-light text-primary m-1 p-2 small"><?= lang('top_paid') ?></a>
    </div>
