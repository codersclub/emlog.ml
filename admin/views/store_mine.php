                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <?php else: ?>
                                        <a href="#" class="btn btn-success installBtn" data-url="<?= urlencode($v['download_url']) ?>" data-cdn-url="<?= urlencode($v['cdn_download_url']) ?>" data-type="<?= $v['type'] ?>"><?= lang('install_now') ?></a>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
