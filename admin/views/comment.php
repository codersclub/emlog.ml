...
<!--vot-->                  <th><?= lang('operation') ?></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($value['hide'] === 'y' && User::haveEditPermission()): ?>
                                        <a class="badge badge-warning" data-pjax="true" href="comment.php?action=pub&id=<?= $cid ?>&token=<?= LoginAuth::genToken() ?>"><?= lang('check') ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
    ...
    <div class="d-flex justify-content-center mb-4 small">
        <div class="form-inline">
            <label for="perpage_num" class="mr-2"><?= lang('have') ?> <?= $cmnum ?> <?= lang('comments_per_page') ?></label>
