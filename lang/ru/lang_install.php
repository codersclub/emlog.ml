...
'php_required'			=> 'Версия PHP слишком старая. Для Emlog требуется PHP7.4 или выше',//'PHP版本太低，推荐使用PHP7.4及以上版本',
...
'db_hostname_info'		=> 'Обычно localhost (или с указанием порта: localhost:3306)',//'通常为 localhost 或者指定端口 localhost:3306',
...
'emlog_install_congratulation'	=> 'Первый пост в блоге создан.\n\nОтредактируйте его или просто удалите, и начинайте наполнять своё собственное содержание!',//'这是系统生成的演示文章。编辑或者删除它，然后开始您的创作吧！',
'my_blog'			=> 'Мой блог',//'点滴记忆',
'emlog_powered'			=> 'Powered by Emlog.ML',//'使用emlog.ML搭建的站点',
...
'emlog_installed'		=> 'Установлено успешно!',//'安装成功了?',
...
'password_entered'		=> 'только-что созданный пароль',//'刚才设定的密码',
...
'system_generated_demo'		=> 'Это демо сгенерировано системой',//'这是系统生成的演示评论',
