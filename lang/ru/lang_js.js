...
// 'saving'		: 'Saving',//'正在保存',
 ...
 'save_system_error'	: 'Ошибка автосохранения. Возможно, в системе произошло исключение или достигнут дневной лимит публикаций',//'网络或系统出现异常...保存可能失败',
...
//----
 ...
 'check_for_new'	: 'Проверить наличие обновлений',//'查看更新内容',
 'update_now'		: 'Обновить сейчас',//'现在更新',
 'check_failed'		: 'Проверка не удалась, возможно проблема с доступом в сети',//'检查失败，可能是网络问题',
 'updating_now'		: 'Идёт обновление, подождите пожалуйста',//'正在更新中，请耐心等待',
 'updated_ok'		: 'Поздравляем! Обновление прошло успешно, <a href="./">обновите страницу</a>, чтобы начать работу с новым Emlog',//'恭喜您！更新成功了，请<a href="./">刷新页面</a>开始体验新版emlog',
