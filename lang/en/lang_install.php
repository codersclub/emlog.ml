...
'php_required'                 => 'PHP version is too low, it is recommended to use PHP7.4 and above',//'PHP版本太低，推荐使用PHP7.4及以上版本',
...
'admin_password_repeat'        => 'Repeat password',//'重复密码',
'email'                        => 'E-Mail',//'邮箱',
'email_prompt'                 => 'can be used to retrieve the password, it is recommended to fill in',//'可用于找回密码，建议填写',
'install_emlog'                => 'Start the installation',//'开始安装',
...
'emlog_install_congratulation' => 'This is a system-generated demo article. Edit or delete it, then start to create your own!',//'这是系统生成的演示文章。编辑或者删除它，然后开始您的创作吧！',
'my_blog'                      => 'My blog',//'点滴记忆',
'emlog_powered'                => 'Powered by Emlog.ML',//'使用emlog搭建的站点',
'emlog_official_site'          => 'Official emlog website',//'emlog官方主页',
'emlog_ml_official_site'       => 'Official Emlog.ML website',//'emlog.ML官方主页',
'home'                         => 'Home',//'首页',
'twitters'                     => 'Notes',//'笔记',
'login'                        => 'Login',//'登录',
'test_twit'                    => 'I heard some whispers last night... :)',//'使用微语记录您身边的新鲜事',
'emlog_installed'              => 'Installed successfully!',//'安装成功了?',
...
'password_entered'             => 'the password you just set',//'刚才设定的密码',
