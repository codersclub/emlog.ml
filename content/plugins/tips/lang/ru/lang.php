...
'array_tips'		=> [
				...
				'Почаще заходите в магазин приложений, вы всегда найдёте для себя сюрпризы',
				...
				'Используйте браузер Chrome, чтобы лучше ознакомиться с возможностями Emlog',
                                'Вы можете использовать заметки для организации фрагментированных текстовых материалов',
				'Будьте счастливы с завтрашнего дня',
                                'E = MC²',
                                'PHP — лучший в мире язык программирования',
			],
];
