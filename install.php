...
CREATE TABLE {$db_prefix}order (
    id bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Orders',
    app_name varchar(32) NOT NULL COMMENT 'Application English alias',
    order_id varchar(64) NOT NULL DEFAULT '' COMMENT 'Order ID',
    order_uid int unsigned NOT NULL COMMENT 'User ID',
    out_trade_no varchar(255) DEFAULT '' COMMENT 'Payment platform serial number',
    pay_type varchar(64) NOT NULL DEFAULT '' COMMENT 'Payment method (alipay/wechat)',
    sku_name varchar(64) NOT NULL DEFAULT '' COMMENT 'Product Type',
    sku_id int NOT NULL,
    price decimal(10, 2) NOT NULL COMMENT 'Price',
    pay_price decimal(10, 2) DEFAULT '0.00' COMMENT 'Amount paid',
